...
class RazerDevice(object):
    ...
    def __init__(self, serial, vid_pid=None, daemon_dbus=None):
        ...
        self._capabilities = {
            ...
            'lighting_logo_pulsate_mono': self._has_feature('razer.device.lighting.logo', 'setLogoPulsateMono'),
            ...
            'lighting_logo_static_mono': self._has_feature('razer.device.lighting.logo', 'setLogoStaticMono'),
